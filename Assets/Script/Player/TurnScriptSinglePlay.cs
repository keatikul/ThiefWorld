...
public class TurnScriptSinglePlay : MonoBehaviour
{
    ...
    public void CheckTurn() 
    {
        ...
        if (checkTurn1 == false && timeValue == 0)
        {
            checkTurn2 = true;
            checkTurn1 = false;
            checkTurn3 = false;
